...
def draw_handler(canvas):
    ...
    paddle1_pos = calculate_paddle_position(paddle1_pos, paddle1_vel)
    paddle2_pos = calculate_paddle_position(paddle2_pos, paddle2_vel)       
...
def calculate_paddle_position(pos, vel) :
